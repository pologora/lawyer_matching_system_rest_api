...
describe.skip('Test GET /cases/:id', () => {
  test('Should respond with 200 success', async () => {
    const response = await supertest(app)
...
describe.skip('Test PATCH /cases/:id', () => {
  test('Should respond with 200 success', async () => {
    const patchData = {
...
describe.skip('Test DELETE /cases/:id', () => {
